...
export class BudgetHistoryController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Budget history entry created successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'List of all budget history entries',
  })
  findAll() {
  ...
  @ApiResponse({
    status: 200,
    description: 'Budget history entries for the specified budget',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Budget history entry updated successfully',
  })
  @ApiResponse({ status: 404, description: 'Budget history entry not found' })
  update(
    @Param('id') id: string,
    @Body() updateBudgetHistoryDto: UpdateBudgetHistoryDto,
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Budget history entry deleted successfully',
  })
  @ApiResponse({ status: 404, description: 'Budget history entry not found' })
